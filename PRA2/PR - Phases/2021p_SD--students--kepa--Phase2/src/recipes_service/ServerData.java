...
//		LSimLogger.log(Level.TRACE,"The recipe '"+recipeTitle+"' has been added");
	...
	/**
	 * Nueva función para simplificar la adicción o elminación de operaciones
	 * Evalua el tipo de operación y actua en consecuencia
	 * @param addOp operación que sera añadida
	 * @param removeOp operación que será eliminada
	 */
